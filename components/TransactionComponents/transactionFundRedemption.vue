<template>
    ...
    <b-card no-body class="investorFund" v-else>
        <form>
			<b-form-group id="inputAmountGroup" :label-cols="2" label="Amt. Withdrawn*" label-for="inputAmount" horizontal :invalid-feedback="feedbackAmount" :state="stateAmount">
				<b-row>
					<b-col sm="5">
            ...
            <b-form-group id="inputToGroup" :label-cols="2" label="From*" label-for="inputTo" horizontal :invalid-feedback="feedbackTo" :state="stateTo">
				<b-row>
					<b-col sm="5">
